...
`,[X("multiple",[F("base-select-option",`
 padding-right: 28px;
 `)]),F("scrollbar",`
 ...
 `),F("base-selection-label","background-color: var(--n-color-active);"),F("base-selection-tags","background-color: var(--n-color-active);")])]),X("disabled","cursor: not-allowed;",[B("arrow",`
 ...
 user-select: none;
 opacity: 0;
 `)]),["warning","error"].map(e=>X(`${e}-status`,[B("state-border",`border: var(--n-border-${e});`),Je("disabled",[he("&:hover",[B("state-border",`
 box-shadow: var(--n-box-shadow-hover-${e});
 border: var(--n-border-hover-${e});
 `)]),X("active",[B("state-border",`
 box-shadow: var(--n-box-shadow-active-${e});
 border: var(--n-border-active-${e});
 `),F("base-selection-label",`background-color: var(--n-color-active-${e});`),F("base-selection-tags",`background-color: var(--n-color-active-${e});`)]),X("focus",[B("state-border",`
